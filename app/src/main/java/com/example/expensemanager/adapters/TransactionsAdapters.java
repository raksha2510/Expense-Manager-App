...
import com.example.expensemanager.views.activities.Home;
...
public class TransactionsAdapters extends  RecyclerView.Adapter<TransactionsAdapters.TransactionViewHolder> {
    ...
    public TransactionsAdapters(Context context, RealmResults<Transaction> transactions) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                deleteDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Yes", (dialogInterface, i) -> {
                    ((Home)context).viewModel.deleteTransaction(transaction);
                });
